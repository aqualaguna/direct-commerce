/**
 * Inventory History Controller tests
 *
 * Tests for inventory history CRUD operations
 */
...
describe('Inventory History Controller', () => {
  let controller: any;
  ...
  beforeEach(() => {
    ...
    const controllerModule = require('./inventory-history').default;
